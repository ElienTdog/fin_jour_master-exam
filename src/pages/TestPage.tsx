        ...
        <div className="max-w-3xl mx-auto space-y-8 pb-24">
          ...
          <div className="flex justify-center pt-8">
            <button
              ...
              className="px-8 py-3 bg-slate-900 text-white font-semibold rounded-xl hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              交卷 / 结束模拟
            </button>
          </div>
